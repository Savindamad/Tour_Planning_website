    ...
    <div class="container">
        ...
        <div class="menu">
            <ul class="nav" id="nav">
                ...
                <li <?php if (isset($current) && ($current == 'places' || $current == 'place')) echo 'class="current"'; ?>><a href="<?php echo base_url('index.php/Places'); ?>">Places to visit</a></li>
                <li <?php if (isset($current) && $current == 'reviews') echo 'class="current"'; ?>><a href="<?php echo base_url('index.php/Reviews'); ?>">Reviews</a></li>
                <div class="clear"></div>
            </ul>
        </div>							
